      ...
      <div className="container ontop">
        <div className="row">
          <div className="col-lg-4">
            <h6>
              <span className="fz-14">02 . </span> Services
            </h6>
          </div>
          <div className="col-lg-6 offset-lg-1">
            <div className="text">
              <h3>
                We create <span className="sub-font">experiences</span> and turn
                ideas into reality.
              </h3>
            </div>
        ...
        <div className="items">
          {data.map((item, index) => (
            <div className="item" key={item.id}>
              <span
                className={`icon icon-img-80 ${
                  index !== data.length - 1 ? "mb-40" : ""
                }`}
              >
                <img
