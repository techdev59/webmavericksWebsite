          ...
          <div className="col-lg-11">
            <div className="caption text-center mt-50">
              ...
              <h1 className="fw-700 fz-80">
                ...
                ></span>{" "}
                sharp brands <span className="sub-font">creators</span> open for
                any{" "}
                <span className="icon-img-60">
                  <img
                    src={`/${
                      lightMode ? "light" : "dark"
                ...
                kind of <span className="stroke fw-800">new</span> works
              </h1>
            </div>
          </div>
        </div>
