      ...
      <div className="frame">
        <nav className="slides-nav">
          <div className="slide-nav-butn">
            ...
            >
              <svg>
                <path d="M1.176 11.532a.5.5 0 00-.352.936c5.228 1.96 9.475 5.555 12.752 10.797a.5.5 0 00.848-.53c-3.39-5.424-7.81-9.163-13.248-11.203z"></path>
                <path d="M1.176 12.468a.5.5 0 01-.352-.936C6.052 9.572 10.3 5.978 13.576.735a.5.5 0 01.848.53c-3.39 5.424-7.81 9.163-13.248 11.203z"></path>
          ...
          <div className="slides-nav__index">
            <span className="slides-nav__index-current">
              <span>1</span>
            </span>
            &mdash;
          ...
          >
            ...
            <figcaption className="slide__caption">
              <h1 className="slides__caption-headline">
                <span className="text-row sub-title mb-15">
                  <span>
                    © {item.year} {item.type}
                  </span>
                </span>
