...
function Testimonials({ lightMode }) {
  ...
  return (
    <section className="testim-crv2 sub-bg">
      <div className="container section-padding position-re">
        <div className="row">
          <div className="col-lg-5">
            ...
            <div className="swiper-controls testim-controls arrow-out d-flex mt-80">
        ...
        <div className="half-img-right bg-img ontop md-hide" data-background={`/${lightMode ? 'light' : 'dark'}/assets/imgs/testim/01.png`}></div>
      </div>
    </section>
  )
}
