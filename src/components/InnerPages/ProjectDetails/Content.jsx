      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-4">
            <div className="text">
              <h3>We create everything digital,Mobile Apps,Web Development,Utilities Development,Custom business Solutions</h3>
            </div>
          </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <ul className="rest dot-list">
                    <li className="mb-15">Custom business Solutions Development</li>
                    <li className="mb-15">Utilities Development</li>
                    <li className="mb-15">Web Development</li>
        ...
        <div className="row md-marg mt-50">
          <div className="col-lg-4">
            <div className="img mb-50">
              <img src="/dark/assets/imgs/works/projects/1/app.png" alt="" />
            </div>
          </div>
          <div className="col-lg-4">
            <div className="img mb-50">
        ...
        <div className="back-image bg-img parallaxie" data-background="/dark/assets/imgs/works/projects/1/sof.png"></div>
        ...
        <div className="row mt-100">
          <div className="col-lg-4">
            <div className="img md-mb50">
              <img src="/dark/assets/imgs/works/projects/1/cini.png" alt="" />
            </div>
          </div>
