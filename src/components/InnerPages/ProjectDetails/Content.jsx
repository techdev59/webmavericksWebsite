      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-4">
            <div className="text">
              <h3>
                We create everything digital,Mobile Apps,Web
                Development,Utilities Development,Custom business Solutions
              </h3>
            </div>
          </div>
        ...
        <div
          ...
          data-background="/dark/assets/imgs/works/projects/1/sof.png"
        ></div>
